 ...
 */
@JsonPropertyOrder({
  CartItemRequest.JSON_PROPERTY_PRODUCT_ID,
  CartItemRequest.JSON_PROPERTY_QUANTITY
})
...
public class CartItemRequest {
  ...
  public CartItemRequest productId(Integer productId) {
 ...
 @Min(1)
  ...
  /**
   * Return true if this CartItemRequest object is equal to o.
   */
  @Override
